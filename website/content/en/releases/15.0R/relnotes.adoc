...
`googletest` has been updated from 1.14.0 to 1.15.2.
...
gitref:16a6da44e28d[repository=src] and gitref:227e7a205edf[repository=src]. (Sponsored by OVHCloud)
...
For the moment, the best documentation is the git commit message, gitref:3eb3a802a31b[repository=src].
...
gitref:472a0ccf847a[repository=src] (Sponsored by Rubicon Communications, LLC ("Netgate")) (Sponsored by BBOX.io)
...
gitref:49f12d5b38f6[repository=src] (Sponsored by Rubicon Communications, LLC ("Netgate")) (Sponsored by BBOX.io)
...
gitref:cf9d2fb18433[repository=src], gitref:7224e9f2d4af[repository=src]
(Sponsored by The FreeBSD Foundation)
