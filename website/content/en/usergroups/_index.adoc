...
If there is no local group, https://meetup.com/ can be used to locate interested individuals near by.
...
Arbian open source community in Saudi Arabia, *BSD one of part of the community, represents and supports Arabic language.
